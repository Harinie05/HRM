...
def create_hr_policy(data: HRPolicyCreate, user=Depends(get_current_user)):
...
def update_hr_policy(id: int, data: HRPolicyCreate, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def delete_hr_policy(id: int, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def create_leave_policy(data: LeavePolicyCreate, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def update_leave_policy(id: int, data: LeavePolicyCreate, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def delete_leave_policy(id: int, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def create_attendance_policy(data: AttendancePolicyCreate, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def update_attendance_policy(id: int, data: AttendancePolicyCreate, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def delete_attendance_policy(id: int, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def create_ot_policy(data: OTPolicyCreate, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def update_ot_policy(id: int, data: OTPolicyCreate, user=Depends(get_current_user)):
    db = get_tenant_session(user)
...
def delete_ot_policy(id: int, user=Depends(get_current_user)):
    db = get_tenant_session(user)
