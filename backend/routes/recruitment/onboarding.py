...
def create_onboarding(candidate_id: int, data: OnboardingCreate, request: Request, db: Session = Depends(get_tenant_db), user = Depends(check_permission("start_onboarding"))):
...
def get_documents(candidate_id: int, request: Request, db: Session = Depends(get_tenant_db), user = Depends(check_permission("view_onboarding_documents"))):
...
def list_onboarding_candidates(request: Request, db: Session = Depends(get_tenant_db), user = Depends(check_permission("view_onboarding_candidates"))):
