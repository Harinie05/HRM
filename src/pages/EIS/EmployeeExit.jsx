          ...
          <div className="space-y-8">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-primary">Resignation Details</h3>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-primary">Exit Interview</h3>
              </div>
            ...
            {/* Final Settlement */}
            <div>
              <h3 className="text-lg font-semibold text-primary mb-4">Final Settlement</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-primary mb-4">Exit Clearance Checklist</h3>
            ...
            {form.resignation_date && (
              <div className="bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 rounded-lg p-6">
                <h4 className="font-semibold text-primary mb-4">Exit Process Status</h4>
