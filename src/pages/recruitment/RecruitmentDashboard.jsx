...
const RecruitmentDashboard = () => {
  return (
    <Layout breadcrumb="Recruitment · Dashboard">
      <div className="p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-gray-800 mb-2">Recruitment & Onboarding Pipeline</h1>
          <p className="text-gray-600">Overview of recruitment activities and candidate pipeline</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-medium text-gray-800">Create Job</h4>
          ...
          <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-medium text-gray-800">View ATS</h4>
