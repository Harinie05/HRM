...
export default function Layout({ children, title, subtitle, stats, breadcrumb }) {
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: 'var(--content-bg, #f8fafc)' }}>
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main className="flex-1 flex flex-col overflow-hidden pt-12 sm:pt-14" style={{ backgroundColor: 'var(--content-bg, #f8fafc)' }}>
            {/* Breadcrumb */}
            {breadcrumb && (
